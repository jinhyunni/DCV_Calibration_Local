...
void plotMake_GaussFitToMainChTimePeak_Summarize_Syst
(
...
)
{
  ...
  auto DrawPlot = [&](TCanvas*& fcanvas, std::vector<int>& chList, bool fSaveAsPdf) {
    ...
    htmp1 -> GetYaxis() -> SetTitleFont(textstyle);
    htmp1 -> GetYaxis() -> SetTitleSize(textsize);
    htmp1 -> GetYaxis() -> SetRangeUser(0.0, 4.7);
    htmp1 -> GetYaxis() -> SetTitle("Chi2/NDF");
    htmp1 -> GetYaxis() -> SetLabelFont(textstyle);
    htmp1 -> GetYaxis() -> SetLabelSize(textsize);

    htmp1 -> GetXaxis() -> SetTitleFont(textstyle);
    htmp1 -> GetXaxis() -> SetTitleSize(0);
    htmp1 -> GetXaxis() -> SetLabelFont(textstyle);
